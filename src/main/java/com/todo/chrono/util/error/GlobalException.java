package com.todo.chrono.util.error;

import com.todo.chrono.dto.response.ResResponse;
...
public class GlobalException {
    ...
    public ResponseEntity<ResResponse<Object>> handleBlogAlreadyExistsException(Exception ex) {
